...
SSH into the bastion and run the following command.  Take note of the vpcid and subnet id on 10.0.0.0/17.  They will be used in the cloud formations command.
...
NOTE: You can monitor the progress of the stack creation from the Cloudformation console on AWS
Cloudformation -> Stacks -> ROSA-FSXONTAP
