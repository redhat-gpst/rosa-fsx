...
SSH into the bastion and run the following command.  Take note of the vpcid and subnet id on 10.0.0.0/17.  They will be used in the CloudFormation command.
